...
class Bvh : public Hittable {
        ...
        if ( object_span == 1 ) {
            ...
            auto comparator =
                boundingBox.lengthX() > boundingBox.lengthY()
                    ? ( boundingBox.lengthX() > boundingBox.lengthZ() ? box_x_compare
                                                                      : box_z_compare )
                    : ( boundingBox.lengthY() > boundingBox.lengthZ() ? box_y_compare
                                                                      : box_z_compare );
   ...
   private:
    ...
    __device__ static void shittySorter( Hittable** objects,
                                         int64_t start,
                                         int64_t end,
